    ...
    <footer>
      ...
      <div className="container px-8 py-16">
        <div className="foot_top mt-6">
          <div className="foot_top_content">
            {screens.isDesktop ? (
              <div className="destop_view grid grid-cols-5  ">
                <ul>
                  Categories
              ...
              <div>
                <Collapse ghost accordion>
                  ...
                  <Panel header="Support and Education" key="3">
                    <ul>
                      {list3.map((item, index) => (
                        <li key={index}>
                          <a>{item}</a>
                  ...
                  <Panel header="Business Solutions" key="5">
                    <ul>
                      {list5.map((item, index) => (
                        <li key={index}>
                          <a>{item}</a>
        ...
        <hr />
        <div className="foot_bottom lg:flex lg:justify-between block text-center items-center">
          <div className="bottom_left pt-4 lg:flex lg:justify-center  ">
          ...
          <div className="bottom_right pt-4 flex-row  lg:flex">
            ...
            <div className="setting_button mt-5 flex justify-center">
              <button className="flex items-center py-2 px-3">
              ...
              <button className="ml-3">US$ USD</button>
              <button className="ml-4 wrapper">
