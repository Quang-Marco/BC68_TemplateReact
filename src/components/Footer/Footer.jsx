      ...
      <div className="container px-8 py-16">
        <div className="foot_top mt-6">
          <div className="foot_top_content grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8  ">
            ...
            <div className="foot_collap pb-10 px-4">
              <ul>
                <p className="text_display_foot_content font-bold">About</p>
                <li>
                  <a href="#">Careers</a>
                </li>
                <li>
            ...
            <div className="foot_collap pb-10 px-4">
              <ul>
                <p className="text_display_foot_content font-bold">Community</p>
                <li>
        ...
        <hr />
        <div className="foot_bottom flex justify-between items-center">
          <div className="bottom_left pt-4 flex ">
            <svg
              width="91"
              height="27"
              viewBox="0 0 91 27"
            ...
            <h3 className="">© Fiverr International Ltd. 2024 </h3>
          </div>
          <div className="bottom_right pt-4 flex">
            ...
            <div className="setting_button flex">
